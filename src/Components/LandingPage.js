...
// import homeP from '../Picture/homepageP.svg'
...
//     const variants = {
//         active: { width: "600px" , height: "150px" },
//         nonActive: { width: "200px", height: "150px"  }
//       };
    
//       const variants2 = {
//         active: { height: "400px" },
//         nonActive: { height: "150px" }
//       };
...
//                         <div className='w-full h-[100vh] overflow-auto relative  justify-center items-center'>

//                             <div className='inset-0 fixed bg-[black] flex w-full z-20 bg-opacity-50'></div>
//                             <img src={homeP} className='w-full h-full object-cover fixed'></img>

//                             <div className='absolute w-full z-50 py-[30px] gap-y-5 flex flex-col justify-around'>

//                                 <div className='text-white z-50 font-bold textS break-words w-full sm:w-[460px] text-center mx-auto text-[26px] md:text-[30px] m-4'>
//                                     WELCOME TO GUIDANCE MANAGEMENT AND COUNSELING SERVICES SYSTEM OF CABANGAN HIGH SCHOOL
//                                 </div>

//                                 <div className=' mx-auto rounded-md w-fit cursor-pointer p-2 textS text-[20px] glass font-bold flex flex-row justify-around gap-x-[10px]'
//                                 onClick={()=> navigate('/login')}>
//                                     <AiFillUnlock size={30}/><span>LOGIN</span>
//                                 </div>



//                                 <div className='hidden lg:block w-full h-full py-4'>
//                                     <div className='w-fit flex flex-row gap-5 mx-auto text-white text-[20px]'>

//                                         <motion.div className={` glass cursor-pointer ${(show === 1) && 'min-h-[400px]'}`}   onClick={()=>setShow(1)}
//                                          initial="active"
//                                          animate={show === 1 ? "active" : "nonActive"}
//                                          css={{ backgroundColor: "#011627" }}
//                                          variants={variants}>
//                                             <div className='flex flex-col justify-center items-center w-full h-full gap-[10px] px-10'>
//                                                 <img src={conversation} alt='Teachers Referral' className='w-[100px] mx-auto'/>
//                                                 {show === 1 &&
//                                                     <>
//                                                         <p>Referral Request</p>
//                                                         <p className='text-[15px] text-justify indent-[50px]'>A referral request for counseling is a formal communication made by one individual or professional to another, typically a counselor or therapist, recommending a person for counseling services. It often includes information about the person in need of counseling, their specific issues or concerns, and the reasons for the referral. Additionally, it may highlight the urgency of the situation or any relevant background information that would assist the counselor in providing appropriate care. Referral requests play a crucial role in helping individuals access the appropriate support and resources for their mental health and well-being.</p>
//                                                     </>}
//                                             </div>
//                                         </motion.div>

//                                         <motion.div className={` glass cursor-pointer ${(show === 2) && 'min-h-[400px]'}`}  onClick={()=>setShow(2)}
//                                          initial="active"
//                                          animate={show === 2 ? "active" : "nonActive"}
//                                          css={{ backgroundColor: "#011627" }}
//                                          variants={variants}>
//                                             <div className='flex flex-col justify-center items-center w-full h-full gap-[10px] px-10'>
...
//                                 <div className='block lg:hidden w-full h-full py-4 px-2'>
//                                     <div className='w-full flex justify-center items-center h-fit flex-col gap-5 mx-auto text-white'>

//                                         <motion.div className='w-fit md:min-w-[300px] glass cursor-pointer'  onClick={()=>setShow(1)}
//                                          initial="active"
//                                          animate={show === 1 ? "active" : "nonActive"}
//                                          css={{ backgroundColor: "#011627" }}
//                                          variants={variants2}>
...
//                                         <motion.div className='w-fit md:min-w-[300px] glass cursor-pointer' onClick={()=>setShow(2)}
//                                          initial="active"
//                                          animate={show === 2 ? "active" : "nonActive"}
//                                          css={{ backgroundColor: "#011627" }}
//                                          variants={variants2}>
...
//                                         <motion.div className='w-fit  md:min-w-[300px] glass cursor-pointer'  onClick={()=>setShow(3)}
//                                          initial="active"
//                                          animate={show === 3 ? "active" : "nonActive"}
//                                          css={{ backgroundColor: "#011627" }}
//                                          variants={variants2}>
                        ...
                        <div className='w-full h-full bg-[#279EFF] rounded-bl-[150px]'>
                            <div className='w-[70%] mx-auto h-full flex flex-col lg:flex-row justify-around items-center gap-y-[50px] '>
                                <div className='w-[400px] h-[400px] flex flex-col items-center justify-center gap-y-[20px]'>  
                                    ...
                                    <div onClick={()=> navigate('/login')} className='flex md:hidden px-10 glass rounded-md pointer p-1 textS text-[20px] font-bold gap-x-[10px] cursor-pointer'>
                                            <span>Login</span>
                                    </div>
                                </div>  
